...
async function main() {
    ...
    await helper.storeAddress(`${network.name}, LPToken: ${lpToken.address}`);
    ...
    await helper.storeAddress(`${network.name}, MasterChef: ${masterChef.address}`);
    ...
    await helper.storeAddress(`${network.name}, RewardToken: ${rewardToken.address}`);
